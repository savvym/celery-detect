...
from ..models import ChoreResult
...
class DatabaseBackend(BaseDictBackend):
    ...
    def _get_meta_from_request(self, request=None):
        ...
        retrieve and stored on the ChoreResult.
        """
    ...
    def _store_result(
        ...
        self.ChoreModel._default_manager.store_result(**task_props)
        return result

    def _get_task_meta_for(self, chore_id):
        """Get task metadata for a task by id."""
        obj = self.ChoreModel._default_manager.get_chore(chore_id)
        res = obj.as_dict()
    ...
    def _forget(self, chore_id):
        try:
            self.ChoreModel._default_manager.get(chore_id=chore_id).delete()
        except self.ChoreModel.DoesNotExist:
            pass

    def cleanup(self):
        """Delete expired metadata."""
        self.ChoreModel._default_manager.delete_expired(self.expires)
